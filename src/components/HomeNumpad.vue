    ...
    <div class="numpad">
      <div class="number-input-box">
        <div class="number-input">
          <div class="number-input-item item-plu" :class="{'is-active': typeInput == 'inputPlu'}" @click="setTypeInput('inputPlu')">
          ...
          <div class="number-input-item item-quantity" :class="{'is-active': typeInput == 'inputQuantity'}" @click="setTypeInput('inputQuantity')">
        ...
        if(!this.isMenge) {
          ...
          if (valueInput === 'enter') {
            if(this.inputValueQuantity < 1 || this.inputValueQuantity === '') {
              ...
              this.$store.dispatch('numboardHome/showHidePopupInvalidQuantity', true);
              this.inputValueQuantity = '';
            ...
            if (this.inputValuePlu !== '') {
              ...
              if(globalFunction.checkValid(productSearch.code)) {
                ...
                this.$store.dispatch('order/setProductToOrderLines', [productSearch]);
