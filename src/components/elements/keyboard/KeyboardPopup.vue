<template>
  <div class="keyboard-wrapper" v-show="isActiveKeyboard">
    <div class="type-popup-keyboard" v-show="isActivePopupKeyboard">
      <div class="popup-keyboard"></div>
    </div>
  </div>
</template>
  ...
  export default {
    ...
    computed: {
      ...mapState({
        ...
        isActivePopupKeyboard: state => state.helper.isActivePopupKeyboard,
      })
    },

    mounted() {
      this.keyboard = new Keyboard(".popup-keyboard", {
